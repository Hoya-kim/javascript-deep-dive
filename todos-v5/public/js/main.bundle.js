...
var store = {
  ...
  notify: function notify() {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_3___default()(_context = this.listeners).call(_context, function (listener) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default().get('/todos');

          case 3:
            _yield$axios$get = _context2.sent;
            todos = _yield$axios$get.data;
            store.todos = todos;
            _context2.next = 11;
            break;
...
var toggleAllTodos = /*#__PURE__*/function () {
  var _ref2 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(completed) {
    var _yield$axios$patch, todos;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default().patch('/todos', {
              completed: completed
            });

          case 3:
            _yield$axios$patch = _context3.sent;
            todos = _yield$axios$patch.data;
            store.todos = todos;
            _context3.next = 11;
            break;
  ...
  return function toggleAllTodos(_x) {
...
var generateId = function generateId() {
  ...
  return Math.max.apply(Math, _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_4___default()(_context4 = (0,_babel_runtime_corejs3_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_5___default()(_context5 = store.todos).call(_context5, function (todo) {
    return todo.id;
  }))).call(_context4, [0])) + 1;
};

var addTodo = /*#__PURE__*/function () {
  var _ref3 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3(content) {
    var _yield$axios$post, todos;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default().post('/todos', {
              id: generateId(),
              content: content,
              completed: false
            });
...
var toggleTodo = /*#__PURE__*/function () {
  var _ref4 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee4(id) {
    var _context7;

    var _store$todos$find, completed, _yield$axios$patch2, todos;

    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _store$todos$find = _babel_runtime_corejs3_core_js_stable_instance_find__WEBPACK_IMPORTED_MODULE_6___default()(_context7 = store.todos).call(_context7, function (todo) {
              return todo.id === +id;
            }), completed = _store$todos$find.completed; // PATCH /todos/${id} { completed: !todo.completed }

            _context8.prev = 1;
            _context8.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_7___default().patch("/todos/".concat(id), {
              completed: !completed
            });

          case 4:
            _yield$axios$patch2 = _context8.sent;
            todos = _yield$axios$patch2.data;
            store.todos = todos;
            _context8.next = 12;
            break;
...
var updateTodoContent = /*#__PURE__*/function () {
  var _ref5 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee5(id, content) {
    var _yield$axios$patch3, todos;

    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee5$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            _yield$axios$patch3 = _context9.sent;
            todos = _yield$axios$patch3.data;
            store.todos = todos;
            _context9.next = 11;
            break;
  ...
  return function updateTodoContent(_x4, _x5) {
    return _ref5.apply(this, arguments);
  };
}();

var removeTodo = /*#__PURE__*/function () {
  var _ref6 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee6(id) {
    var _yield$axios$delete, todos;

    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee6$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.prev = 0;
            _context10.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default()["delete"]("/todos/".concat(id));

          case 3:
            _yield$axios$delete = _context10.sent;
            todos = _yield$axios$delete.data;
            store.todos = todos;
            _context10.next = 11;
            break;
  ...
  return function removeTodo(_x6) {
    return _ref6.apply(this, arguments);
  };
}();

var removeAllCompletedTodos = /*#__PURE__*/function () {
  var _ref7 = (0,_babel_runtime_corejs3_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee7() {
    var _yield$axios$delete2, todos;

    return _babel_runtime_corejs3_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee7$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            _context11.prev = 0;
            _context11.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_7___default()["delete"]('/todos/completed');

          case 3:
            _yield$axios$delete2 = _context11.sent;
            todos = _yield$axios$delete2.data;
            store.todos = todos;
            _context11.next = 11;
            break;
  ...
  return function removeAllCompletedTodos() {
...
var render = function render(state) {
  ...
  var _todos = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(todos).call(todos, function (todo) {
    return currentFilter === 'completed' ? todo.completed : currentFilter === 'active' ? !todo.completed : true;
  });

  $todoList.innerHTML = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1___default()(_todos).call(_todos, function (_ref) {
    var _context, _context2, _context3;

    var id = _ref.id,
        content = _ref.content,
        completed = _ref.completed;
    return _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_2___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_2___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = "\n        <li data-id=\"".concat(id, "\">\n          <div class=\"view\">\n            <input type=\"checkbox\" class=\"toggle\" ")).call(_context3, completed ? 'checked' : '', "/>\n            <label>")).call(_context2, content, "</label>\n            <button class=\"destroy\"></button>\n          </div>\n          <input class=\"edit\" value=\"")).call(_context, content, "\" />\n        </li>");
  }).join(''); // todo의 갯수가 0이면 .main, .footer 요소를 비표시한다.

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_3___default()(_context4 = [$main, $footer]).call(_context4, function ($el) {
    return $el.classList.toggle('hidden', todos.length === 0);
  });

  var activeTodos = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(todos).call(todos, function (todo) {
    return !todo.completed;
  }); // activeTodos의 갯수가 0 또는 1개면 'n item left' todo의 갯수가 2개 이상이면 'n items left'


  $todoCount.textContent = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_2___default()(_context5 = "".concat(activeTodos.length, " ")).call(_context5, activeTodos.length > 1 ? 'items' : 'item', " left"); // completed 상태인 todo가 없으면 비표시한다

  var completedTodo = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(todos).call(todos, function (todo) {
    return todo.completed;
  });
...
/* harmony import */ var _store_todos_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/todos.js */ "./src/js/store/todos.js");
/* harmony import */ var _render_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./render.js */ "./src/js/todos/render.js");
...
var $clearCompleted = document.querySelector('.clear-completed'); // Event bindings
// initial rendering

window.addEventListener('DOMContentLoaded', function () {
  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].fetchTodos();
}); // toggle all todo completed

$toggleAll.onchange = function (e) {
  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].toggleAllTodos(e.target.checked);
}; // add todo
...
$newTodo.onkeyup = function (e) {
  ...
  var content = _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_0___default()(_context = e.target.value).call(_context);

  if (content !== '') _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].addTodo(content);
  e.target.value = '';
...
$todoList.onchange = function (e) {
  ...
  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].toggleTodo(e.target.closest('li').dataset.id);
}; // edit mode
...
$todoList.onkeyup = function (e) {
  ...
  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].updateTodoContent(e.target.closest('li').dataset.id, e.target.value);
}; // remove todo


$todoList.onclick = function (e) {
  if (!e.target.classList.contains('destroy')) return;
  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].removeTodo(e.target.closest('li').dataset.id);
}; // filter todos
...
$filters.onclick = function (e) {
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = $filters.querySelectorAll('a')).call(_context2, function ($filter) {
    $filter.classList.toggle('selected', $filter === e.target);
  });

  _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].setFilter(e.target.id);
}; // remove all completed todos


$clearCompleted.onclick = _store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].removeAllCompletedTodos; // Observe : store => state changed => render

_store_todos_js__WEBPACK_IMPORTED_MODULE_2__["default"].subscribe(_render_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
})();
